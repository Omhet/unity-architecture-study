...
Define and execute schema version migrations for save data, ensuring older save files can be safely upgraded to the current format before deserialization.
