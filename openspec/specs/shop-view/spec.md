...
Defines the shop UI section view, including reactive rendering of available items, item cards with pricing and buy buttons, and proper subscription lifecycle management.
